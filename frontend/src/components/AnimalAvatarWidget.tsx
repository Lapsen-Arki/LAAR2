...
const AnimalAvatarWidget: React.FC<{ onSelect: (selectedAvatar: string) => void }> = ({ onSelect }) => {
  ...
  const animalOptions = [
    ...
    {
      name: 'Hiiri',
      imageUrl: 'https://www.svgrepo.com/show/454503/animal-domestic-mouse2.svg',
    },
    {
      name: 'Hiiri', 
    ...
    {
        name: 'Sarvikuono',
        imageUrl: 'https://www.svgrepo.com/show/454508/animal-domestic-pet-12.svg',
      },
      {
        name: 'Kissa',
      ...
      {
        name: 'Coala',
        imageUrl: 'https://www.svgrepo.com/show/454514/animal-domestic-face-2.svg',
      },
      {
        name: 'Medusa',
        imageUrl: 'https://www.svgrepo.com/show/454515/animal-domestic-octopus-3.svg',
      },
      {
        name: 'Koira',
      ...
      {
        name: 'Gorilla',
        imageUrl: 'https://www.svgrepo.com/show/454518/animal-domestic-orangoutang.svg',
      },
      {
        name: 'Ampiainen',
      ...
      {
        name: 'Kirahvi',
        imageUrl: 'https://www.svgrepo.com/show/454521/animal-domestic-giraffe.svg',
      },
      {
        name: 'Karhu',
      ...
      {
        name: 'Ankka',
        imageUrl: 'https://www.svgrepo.com/show/454533/animal-babyduck-domestic.svg',
      },
      {
        name: 'Lintu',
        imageUrl: 'https://www.svgrepo.com/show/454538/animal-bird-domestic-2.svg',
      },
      {
        name: 'Etana',
      ...
      {
        name: 'Siili',
        imageUrl: 'https://www.svgrepo.com/show/454554/animal-domestic-hedgehog.svg',
      },
      {
        name: 'Kala',
        imageUrl: 'https://www.svgrepo.com/show/454555/animal-aquarium-domestic2.svg',
      },
      {
        name: 'Hai',
        imageUrl: 'https://www.svgrepo.com/show/454561/animal-domestic-pet-17.svg',
      },
      {
        name: 'Pöllö',
      ...
      {
        name: 'Kilpikonna',
        imageUrl: 'https://www.svgrepo.com/show/454580/animal-domestic-pet-15.svg',
      },
      {
        name: 'Koira',
    ...
    const handleSelect = (animal: { name: string, imageUrl?: string, imageComponent?: JSX.Element }) => {
